                  ...
                  <div class="inset-3 inset tb-terminal">
                    <div class="inset-4 inset tb-terminal">
                      ...
                      <?php
                        ...
                        if (!empty($page['footer_third'])) { $colCount++; }
                        if (!empty($page['footer_fourth'])) { $colCount++; }
                        if ($colCount > 1) { $gridClass = ' left'; }
                        if ($colCount == 1) { $gridClass = ' only'; }
                      ?>
                      ...
                      <div class="box col-<?php echo $colCount; ?> clearfix tb-terminal">
						...
						<?php if (!empty($page['footer_third'])) : ?>
                          <div class="col-third col<?php if(isset($gridClass)) { echo $gridClass; } if($colCount == $counter){ echo ' last'; } $counter++; ?> tb-height-balance tb-terminal">
                            <div id="footer-third-region" class="tb-region tb-scope">                          
						...
						<?php if (!empty($page['footer_fourth'])) : ?>
                          <div class="col-fourth col<?php if(isset($gridClass)) { echo $gridClass; } if($colCount == $counter){ echo ' last'; } $counter++; ?> tb-height-balance tb-terminal">
                            <div id="footer-fourth-region" class="tb-region tb-scope">                          
