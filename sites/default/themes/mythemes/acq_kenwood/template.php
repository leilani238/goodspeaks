 ...
 */
function acq_kenwood_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _acq_kenwood_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function acq_kenwood_html_head_alter(&$head_elements) {
...
function acq_kenwood_preprocess_page(&$variables) {
  ...
  $layoutClass = _acq_kenwood_get_layout();
 ...
 */
function acq_kenwood_preprocess_block(&$vars) {
 ...
 */
function _acq_kenwood_variable_get($key, $default) {
  global $theme;
 ...
 */
function _acq_kenwood_get_layout() {
  $layout_patterns = _acq_kenwood_variable_get('layout', array('<global>' => 'body-layout-fixed-abc'));
 ...
 */
function acq_kenwood_node_view_alter(&$build) {
...
function acq_kenwood_preprocess_forum_topic_list(&$vars) {
 ...
 */
function acq_kenwood_preprocess_comment_wrapper(&$vars) {
 ...
 */
function acq_kenwood_preprocess_media_gallery_license(&$vars) {
