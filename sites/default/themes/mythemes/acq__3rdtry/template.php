 ...
 */
function acq__3rdtry_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'theme-markup-2';
  $vars['classes_array'][] = _acq__3rdtry_get_layout();
}

/**
 * Implements hook_html_head_alter().
 */
function acq__3rdtry_html_head_alter(&$head_elements) {
...
function acq__3rdtry_preprocess_page(&$variables) {
  ...
  $layoutClass = _acq__3rdtry_get_layout();
 ...
 */
function acq__3rdtry_preprocess_block(&$vars) {
 ...
 */
function _acq__3rdtry_variable_get($key, $default) {
  global $theme;
 ...
 */
function _acq__3rdtry_get_layout() {
  $layout_patterns = _acq__3rdtry_variable_get('layout', array('<global>' => 'body-layout-fixed-ca'));
 ...
 */
function acq__3rdtry_node_view_alter(&$build) {
 ...
 */
function acq__3rdtry_preprocess_forum_topic_list(&$vars) {
 ...
 */
function acq__3rdtry_preprocess_media_gallery_license(&$vars) {
